                ...
                <div class="card-body p-0">
                    <div class="best-product p-2 mb-3">
                        <div class="best-product-item">
                            <div class="d-flex align-items-center gap-3">
                                <div class="product-box border">
                                    <img src="{{asset('adminAseet')}}/assets/images/products/01.png" alt="">
                                </div>
                        ...
                        <div class="best-product-item">
                            <div class="d-flex align-items-center gap-3">
                                <div class="product-box border">
                                    <img src="{{asset('adminAseet')}}/assets/images/products/02.png" alt="">
                                </div>
                                <div class="product-info">
                        ...
                        <div class="best-product-item">
                            <div class="d-flex align-items-center gap-3">
                                <div class="product-box border">
                                    <img src="{{asset('adminAseet')}}/assets/images/products/03.png" alt="">
                                </div>
                                <div class="product-info">
                        ...
                        <div class="best-product-item">
                            <div class="d-flex align-items-center gap-3">
                                <div class="product-box border">
                                    <img src="{{asset('adminAseet')}}/assets/images/products/04.png" alt="">
                                </div>
                                <div class="product-info">
                        ...
                        <div class="best-product-item">
                            <div class="d-flex align-items-center gap-3">
                                <div class="product-box border">
                                    <img src="{{asset('adminAseet')}}/assets/images/products/05.png" alt="">
                                </div>
                                <div class="product-info">
                        ...
                        <div class="best-product-item">
                            <div class="d-flex align-items-center gap-3">
                                <div class="product-box border">
                                    <img src="{{asset('adminAseet')}}/assets/images/products/06.png" alt="">
                                </div>
                                <div class="product-info">
                        ...
                        <div class="best-product-item">
                            <div class="d-flex align-items-center gap-3">
                                <div class="product-box border">
                                    <img src="{{asset('adminAseet')}}/assets/images/products/07.png" alt="">
                                </div>
                                <div class="product-info">
                        ...
                        <div class="best-product-item">
                            <div class="d-flex align-items-center gap-3">
                                <div class="product-box border">
                                    <img src="{{asset('adminAseet')}}/assets/images/products/08.png" alt="">
                                </div>
                                <div class="product-info">
            ...
            <div class="card radius-10 w-100">
                ...
                <div class="top-sellers-list p-2 mb-3">
                    <div class="d-flex align-items-center gap-3 sellers-list-item">
                        <img src="{{asset('adminAseet')}}/assets/images/avatars/avatar-1.png" class="rounded-circle" width="50" height="50" alt="">
                        <div>
                    ...
                    <div class="d-flex align-items-center gap-3 sellers-list-item">
                        <img src="{{asset('adminAseet')}}/assets/images/avatars/avatar-2.png" class="rounded-circle" width="50" height="50" alt="">
                        <div>
                    ...
                    <div class="d-flex align-items-center gap-3 sellers-list-item">
                        <img src="{{asset('adminAseet')}}/assets/images/avatars/avatar-3.png" class="rounded-circle" width="50" height="50" alt="">
                        <div>
                    ...
                    <div class="d-flex align-items-center gap-3 sellers-list-item">
                        <img src="{{asset('adminAseet')}}/assets/images/avatars/avatar-4.png" class="rounded-circle" width="50" height="50" alt="">
                        <div>
                    ...
                    <div class="d-flex align-items-center gap-3 sellers-list-item">
                        <img src="{{asset('adminAseet')}}/assets/images/avatars/avatar-5.png" class="rounded-circle" width="50" height="50" alt="">
                        <div>
                    ...
                    <div class="d-flex align-items-center gap-3 sellers-list-item">
                        <img src="{{asset('adminAseet')}}/assets/images/avatars/avatar-6.png" class="rounded-circle" width="50" height="50" alt="">
                        <div>
                    ...
                    <div class="d-flex align-items-center gap-3 sellers-list-item">
                        <img src="{{asset('adminAseet')}}/assets/images/avatars/avatar-7.png" class="rounded-circle" width="50" height="50" alt="">
                        <div>
                    ...
                    <div class="d-flex align-items-center gap-3 sellers-list-item">
                        <img src="{{asset('adminAseet')}}/assets/images/avatars/avatar-8.png" class="rounded-circle" width="50" height="50" alt="">
                        <div>
                    ...
                    <div class="d-flex align-items-center gap-3 sellers-list-item">
                        <img src="{{asset('adminAseet')}}/assets/images/avatars/avatar-9.png" class="rounded-circle" width="50" height="50" alt="">
                        <div>
                            <h6 class="mb-0">David Buckley</h6>
                    ...
                    <div class="d-flex align-items-center gap-3 sellers-list-item">
                        <img src="{{asset('adminAseet')}}/assets/images/avatars/avatar-10.png" class="rounded-circle" width="50" height="50" alt="">
                        <div>
                            <h6 class="mb-0">Victoria Hardy</h6>
                ...
                <table class="table align-middle mb-0">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center gap-3">
                                <div class="product-box border">
                                    <img src="{{asset('adminAseet')}}/assets/images/products/11.png" alt="">
                                </div>
                                <div class="product-info">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center gap-3">
                                <div class="product-box border">
                                    <img src="{{asset('adminAseet')}}/assets/images/products/17.png" alt="">
                                </div>
                                <div class="product-info">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center gap-3">
                                <div class="product-box border">
                                    <img src="{{asset('adminAseet')}}/assets/images/products/10.png" alt="">
                                </div>
                                <div class="product-info">
